    ...
    <section className="w-full py-20 lg:py-32 px-4 sm:px-6 lg:px-12 relative z-20 bg-transparent">
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col gap-12 md:gap-24 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 md:gap-8">
          ...
          >
            <button className="flex-shrink-0 group flex items-center justify-center gap-2 bg-white text-black px-8 py-3.5 md:py-4 rounded-full font-bold hover:bg-white/90 transition-all hover:scale-[1.02] active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.2)] w-full lg:w-auto text-[15px] md:text-base">
