  ...
  return (
    <section className="max-w-6xl mx-auto mb-32 px-6 sm:px-12 lg:px-16">
      <div className="text-center mb-16 md:mb-24">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-medium text-white mb-12 tracking-tight">Strategic Focus</h2>
        <p className="text-white/50 font-mono text-[16px] max-w-2xl mx-auto leading-[1.8]">The pillars of our architectural approach. Designed for enterprise scale with startup agility.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        {[
          ...
          >
            ...
            <p className="text-white/50 text-[14px] font-mono leading-[1.8]">{focus.desc}</p>
          </div>
        ))}
      </div>
    </section>
