...
import { Eye, ShieldCheck, Database, Search, Terminal, AlertTriangle, AlertCircle, Cpu, RefreshCw, Layers } from 'lucide-react';
...
export default function InsightsPage() {
  ...
  return (
    <main id="insights-page" className="min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-brand-yellow selection:text-black relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 relative z-10 w-full flex-grow">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            ...
            Post-Inference Trace Auditor
          </motion.div>
          
          <h1 className="text-[40px] leading-[1.05] sm:text-5xl lg:text-6xl font-extrabold font-display tracking-tight text-white mb-6">
            Audit Post-Inference <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-ivory to-brand-yellow">Cognitive Decisiveness.</span>
          </h1>
          
          <p className="text-base sm:text-lg text-white/50 font-medium leading-relaxed max-w-2xl mx-auto">
            Audit precisely what prompts your autonomous nodes read, what database variables they retrieved, and how their safety checkpoints reacted.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-24">
          ...
          <div className="lg:col-span-5 bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 flex flex-col backdrop-blur-md">
          ...
          <div className="lg:col-span-7 bg-[#050505] border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-between">
            ...
            <div className="p-4 bg-white/5 border-t border-white/10 flex justify-between items-center text-xs font-bold text-white/50">
              ...
              <button 
                onClick={() => alert(`Trace session ${selectedTrace.id} report successfully exported with schema signature checksum values verified.`)}
